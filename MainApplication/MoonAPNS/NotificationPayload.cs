...
namespace MainApplication.MoonAPNS
{
	public class NotificationPayload
	{
		...
		public string ToJson()
		{
			...
			// MainApplication.Program.Display("NotificationPayload ToJson rawString:" + rawString);
			//MainApplication.Program.Display("NotificationPayload ToJson encodedString:" + encodedString);
